...
def get_r_A_uf_i(i):
    ...
    :param i: 暖冷房区画の番号
    :type i: int
    :return: 暖冷房区画iの床面積のうち床下空間に接する床面積の割合 (-)
    :rtype: float
    """
...
def get_L_uf(A_s_ufvnt_A):
    ...
    :type A_s_ufvnt_A: float
    :return: 当該住戸の外気を導入する床下空間の基礎外周長さ (6)
    :rtype:
    """
...
def get_r_a():
    ...
    :return: 床下の平面形状(アスペクト比等)を考慮した係数(無次元)
    :rtype: float
    """
    return 1.02
...
def get_table_e_3():
    ...
    :return: 表E.3 断熱性能の区分jの熱損失係数Qjにおける標準住戸の床の熱貫流率
    :rtype: list
    """
    table_e_3 = [
...
def get_U_s_R_Q_j(region, j):
    ...
    :param j: 断熱性能の区分
    :type j: int
    :return: 断熱性能の区分jの熱損失係数Q_jにおける標準住戸の床の熱貫流率 (W/m2K)
    :rtype: float
    """
...
def get_table_e_4():
    ...
    :return: 表E.4 断熱性能の区分jの計算対象住戸の基礎の仮想線熱貫流率
    :rtype: list
    """
...
def get_table_e_6():
    ...
    :return: 表 E.6 暖冷房区画iの床面積のうち床下空間に接する床面積の割合
    :rtype: list
    """
...
def calc_Theta(region, A_A, A_MR, A_OR, Q, r_A_ufvnt, underfloor_insulation, Theta_sa_d_t, Theta_ex_d_t,
    ...
    :param H_OR_C:
    :type H_OR_C: str
    :param L_dash_H_R_d_t: 標準住戸の負荷補正前の暖房負荷 (MJ/h)
    :type L_dash_H_R_d_t: ndarray
    :param L_dash_CS_R_d_t: 標準住戸の負荷補正前の冷房顕熱負荷 （MJ/h）
    :type L_dash_CS_R_d_t: ndarray
...
def get_table_e_7():
    ...
    :return: 表 E.7 指数項mにおける公比r_m及び吸熱応答係数phi_1_A_m
    :rtype: list
    """
    table_e_7 = [
...
def get_phi_1_A_m(m):
    ...
    :param m: 指数項m
    :type m: int
    :return: 指数項mにおける吸熱応答係数phi_1_A_m
    :rtype: tuple
    """
