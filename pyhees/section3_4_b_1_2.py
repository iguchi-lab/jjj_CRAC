...
def get_f_H_i_1(region, glass_spec_category):
    ...
    :return: 天窓等の屋根又は屋根の直下の天井に設置されている開口部の暖房期の取得日射熱補正係数
    :rtype: float
    """
...
def get_f_C_i_1(region, glass_spec_category):
    ...
    :param glass_spec_category: ガラスの仕様の区分
    :type glass_spec_category: str
    :return: 天窓等の屋根又は屋根の直下の天井に設置されている開口部の冷房期の取得日射熱補正係数
    :rtype: float
    """
...
def get_f_H_i_2(region, glass_spec_category, direction):
    ...
    :type direction: str
    :return: 当該開口部の上部に日除けが設置されていない場合の開口部の暖房期の取得日射熱補正係数
    :rtype: float
    """
...
def get_f_C_i_2(region, glass_spec_category, direction):
    ...
    :param direction: 外皮の部位の方位
    :type direction: str
    :return: 当該開口部の上部に日除けが設置されていない場合の開口部の冷房期の取得日射熱補正係数
    :rtype: float
    """
...
def get_table_2(region, glass_spec_category, H_or_C, direction):
    ...
    :param direction: 外皮の部位の方位
    :type direction: str
    :return: 当該開口部の上部に日除けが設置されていない場合の開口部の取得日射熱補正係数
    :rtype: float
    """
