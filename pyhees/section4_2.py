...
if __name__ == '__main__':
    ...
    from section3_2 import calc_r_env, get_Q_dash, get_eta_H, get_eta_C
    ...
    for i in range(3):
        mu_H = get_eta_H(eta_A_H[i], r_env)
        mu_C = get_eta_C(eta_A_C[i], r_env)
        ...
        E_H_d_t = get_E_H_d_t(region, sol_region, A_A, A_MR, A_OR, A_env, mu_H, mu_C, Q, mode_H, H_A, spec_MR, spec_OR,
                              spec_HS, mode_MR, mode_OR, CG, SHC, heating_flag_d, L_H_d_t_i, L_CS_d_t_i, L_CL_d_t_i)
