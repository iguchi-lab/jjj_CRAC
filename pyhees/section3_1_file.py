...
def read_csv(hc, filename):
    ...
    :rtype: DataFrame
    """
    path = os.path.join('data', '3-1_HukaData_151019_unifyLDK', filename)
    print(path)
    if hc == 'H':
